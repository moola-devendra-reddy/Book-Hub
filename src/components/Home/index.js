...
class Home extends Component {
  ...
  getTopRatedBooks = async () => {
    this.setState({
      topRatedApiStatus: topRatedApiStatuses.inProgress,
    })
    ...
    if (response.ok === true) {
      ...
      this.setState({
        topRatedApiStatus: topRatedApiStatuses.failure,
      })
    }
  }
  ...
  renderSliderFailureView = () => (
    <div className="top-rated-books-failure-container">
      <img
        ...
        src="https://res.cloudinary.com/dynx081ls1/image/upload/v1645337269/Group_7522_vwrftg.png"
        alt="failure view"
      />
